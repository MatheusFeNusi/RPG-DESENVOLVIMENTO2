...
export default class Interacao extends React.Component {
    ...
    render() {
        ...
        const footerSairSala = (
            <div>
                <Link to="/"> <Button label="Sim" icon="pi pi-check" onClick={this.onHide} /></Link>

                <Button label="Não" icon="pi pi-times" onClick={this.onHide} className="p-button-secondary" />
            </div>
        );
            ...
            <div className="container" style={{ backgroundImage: `url(${TeladeFundo})` }}>
                ...
                <Row md={12} style={{ backgroundImage: `url(${FichaMestre})` }}>
                    <div className="content-section implementation"  >
                        <Dialog header="Sair da sala" visible={this.state.visible} style={{ width: '50vw' }} footer={footerSairSala} onHide={this.onHide} maximizable>
